...
# Match local Arduino build options exactly (same CPU/flash settings)
...
# Pin esp32 core version to match your local environment
...
install:
	...
	# Pin the esp32 core version (prevents CI silently using 3.3.5+)
