...
\DoxyCodeLine{62   \textcolor{keywordflow}{if} (!Vortex::vcallbacks()-\/>serialCheck()) \{}
\DoxyCodeLine{63     \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{64   \}}
\DoxyCodeLine{65   Vortex::vcallbacks()-\/>serialBegin(\mbox{\hyperlink{VortexConfig_8h_ad89976cc0b5340110179f6ce40df3028}{SERIAL\_BAUD\_RATE}});}
...
References Time\+::get\+Curtime(), is\+Connected(), m\+\_\+last\+Check, m\+\_\+serial\+Connected, MAX\+\_\+\+SERIAL\+\_\+\+CHECK\+\_\+\+INTERVAL, MENU\+\_\+\+EDITOR\+\_\+\+CONNECTION, Menus\+::open\+Menu(), and SERIAL\+\_\+\+BAUD\+\_\+\+RATE.
...
\DoxyCodeLine{155   \textcolor{keywordflow}{return} (Vortex::vcallbacks()-\/>serialAvail() > 0);}
...
\DoxyCodeLine{127   uint32\_t amt = Vortex::vcallbacks()-\/>serialAvail();}
...
\DoxyCodeLine{137     \textcolor{keywordflow}{if} (!Vortex::vcallbacks()-\/>serialRead((\textcolor{keywordtype}{char} *)\&\textcolor{keywordtype}{byte}, 1)) \{}
...
\DoxyCodeLine{111   Vortex::vcallbacks()-\/>serialWrite((\textcolor{keyword}{const} uint8\_t *)\&size, \textcolor{keyword}{sizeof}(size));}
\DoxyCodeLine{112   Vortex::vcallbacks()-\/>serialWrite((\textcolor{keyword}{const} uint8\_t *)byteStream.\mbox{\hyperlink{classByteStream_a6993f9575592309a501156db31f82554}{rawData}}(), byteStream.\mbox{\hyperlink{classByteStream_a755097adde5b21b33d3c4e3623d04f97}{rawSize}}());}
...
\DoxyCodeLine{94   Vortex::vcallbacks()-\/>serialWrite(buf, len);}
