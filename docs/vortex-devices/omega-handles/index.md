...
<img align="right" width="" height="220" class="device-icon" src="{{ '/assets/images/device-handle.png' | relative_url }}">
...
<div class="next-steps">
  <ul>
    ...
    <li><a href="{{ site.baseurl }}{% link vortex-devices/omega-handles/upgrade-guide.md %}">Upgrade Your Device</a>: Ensure your device has the latest firmware for optimal performance.</li>
  </ul>
</div>
