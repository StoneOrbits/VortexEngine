...
<div class="next-steps">
  <ul>
    ...
    <li><a href="{% link vortex-devices/omega-handles/upgrade-guide.md %}">Upgrade Your Device</a>: Ensure your device has the latest firmware for optimal performance.</li>
  </ul>
</div>
