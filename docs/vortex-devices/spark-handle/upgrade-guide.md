...
<img src="{{ '/assets/images/spark-handle-render.png' | relative_url }}" style="max-width: 250px; width: 40%; float: right">
...
<div style="text-align: center; margin: 20px; display:flex; flex-direction: column; align-items: center;">
  <img src="{{ '/assets/images/spark-firmware-update.png' | relative_url }}">
</div>
