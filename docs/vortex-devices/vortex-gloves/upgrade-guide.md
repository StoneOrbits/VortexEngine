...
<img src="{{ '/assets/images/device-gloves.png' | relative_url }}" style="max-width: 250px; width: 40%; float: right">
...
<div style="text-align: center; margin: 20px">
  <img src="{{ '/assets/images/trinketboot-drive.png' | relative_url }}" style="box-shadow: 2px 2px 10px rgba(0, 0, 0, 0.2); border-radius: 5px;">
</div>
