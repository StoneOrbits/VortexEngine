...
<img src="{{ '/assets/images/duo-logo-square-512.png' | relative_url }}" style="max-width: 250px; width: 40%; float: right; margin-bottom: 20px">
...
<div style="text-align: center; margin: 5px">
  <img style="max-width:260px;border-radius:5px;border:1px solid gray;" src="{{ '/assets/images/duo-case-removal.gif' | relative_url }}">
  <img style="max-width:260px;border-radius:5px;border:1px solid gray;" src="{{ '/assets/images/duo-case-removal-2.gif' | relative_url }}">
</div>
...
<div style="text-align: center; margin: 5px">  
  <img style="max-width:260px;border-radius:5px;border:1px solid gray;" src="{{ '/assets/images/battery-removal-1.gif' | relative_url }}">
  <img style="max-width:260px;border-radius:5px;border:1px solid gray;" src="{{ '/assets/images/battery-removal-2.gif' | relative_url }}">
</div>
...
<div style="text-align: center; margin: 5px">
  <img style="max-width:260px;border-radius:5px;border:1px solid gray;" src="{{ '/assets/images/connect-chromalink.gif' | relative_url }}">
  <img style="max-width:260px;border-radius:5px;border:1px solid gray;" src="{{ '/assets/images/connect-chromadeck.gif' | relative_url }}">
</div>
...
<div style="text-align: center; margin: 20px">
  <img style="max-width:260px;border-radius:5px;border:1px solid gray;" src="{{ '/assets/images/insert-dock-1.gif' | relative_url }}">
  <img style="max-width:260px;border-radius:5px;border:1px solid gray;" src="{{ '/assets/images/insert-dock-2.gif' | relative_url }}">
</div>
...
<div style="text-align: center; margin-top: 30px;">
  <p><h3 style="color: white;">Congratulations</h3> The Duo is ready for <a href="{{ site.baseurl }}{% link vortex-devices/duo/programming-guide/chromalink-guide/upgrade-guide.md %}">updates</a></p>
</div>
