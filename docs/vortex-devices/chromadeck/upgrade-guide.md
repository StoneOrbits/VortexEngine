...
<img src="{{ '/assets/images/Chromadeck-Render.png' | relative_url }}" style="max-width: 250px; width: 40%; float: right">
...
<div style="text-align: center; margin: 20px">
  ...
  <img src="{{ '/assets/images/connect-device.png' | relative_url }}">
</div>
...
<div style="text-align: center; margin: 20px; display:flex; flex-direction: column; align-items: center;">
  <img src="{{ '/assets/images/chromadeck-firmware-update.png' | relative_url }}">
</div>  
