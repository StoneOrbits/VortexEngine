...
Each Vortex Device offers the same functionality and menus, with the only differences in behaviour coming from the varying LED counts and orientations.
...
The <span style="color: #00ff00;">Color Select</span>, <span style="color: #3366ff;">Pattern Select</span>, <span style="color: #ffffff;">Randomizer</span>, and <span style="color: #00ffff;">Mode Sharing</span> menus will only affect the mode that was selected before opening the menus.

<span style="color: #ff0000;">Factory Reset</span> and <span style="color: #ffff00;">Global Brightness</span> will apply to the entire device, not just the selected mode.
