...
<div style="text-align: center;">
  ...
  <img width="220" height="220" class="device-icon" src="{{ '/assets/images/spark-handle-render.png' | relative_url }}" alt="Spark Handle">
  <img width="220" height="220" class="device-icon" src="{{ '/assets/images/Chromadeck-Render.png' | relative_url }}" alt="Chromadeck">
</div>
