...
Referenced by Timer\+::alarm(), Mode\+Sharing\+::begin\+Sending(), Leds\+::blink\+All(), Leds\+::blink\+Index(), Leds\+::blink\+Map(), Leds\+::blink\+Pair(), Leds\+::blink\+Pairs(), Leds\+::blink\+Range(), Menu\+::blink\+Selection(), Serial\+Coms\+::check\+Serial(), Mode\+Sharing\+::continue\+Sending(), Vortex\+::handle\+Input\+Queue(), Mode\+Sharing\+::init(), Timer\+::on\+End(), Timer\+::on\+Start(), Menus\+::open\+Menu\+Selection(), Mode\+Sharing\+::receive\+Mode(), Mode\+Sharing\+::run(), Randomizer\+::run(), Vortex\+Engine\+::run\+Main\+Logic(), Menus\+::run\+Menu\+Selection(), IRSender\+::send(), VLSender\+::send(), Modes\+::set\+Cur\+Mode(), Menu\+::show\+Bulb\+Selection(), Pattern\+Select\+::show\+List\+Selection(), Timer\+::start(), and Button\+::update().
...
Referenced by IRSender\+::begin\+Send(), VLSender\+::begin\+Send(), delay\+Microseconds(), init(), IRReceiver\+::recv\+PCIHandler(), and tick\+Clock().
