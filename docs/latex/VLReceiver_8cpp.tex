...
Definition at line 27 of file VLReceiver.\+cpp.
...
Definition at line 39 of file VLReceiver.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{40 \{}
\DoxyCodeLine{41   \textcolor{comment}{// this will store the last known state}}
\DoxyCodeLine{42   \textcolor{keyword}{static} \textcolor{keywordtype}{bool} wasAboveThreshold = \textcolor{keyword}{false};}
\DoxyCodeLine{43   \textcolor{comment}{// grab the current analog value but divide it by 8 (the number of samples)}}
\DoxyCodeLine{44   uint16\_t val = (ADC0.RES >> \mbox{\hyperlink{VLReceiver_8cpp_a1682c770d91c5d167b621a782be940d4}{SAMPLE\_COUNT}});}
\DoxyCodeLine{45   \textcolor{comment}{// calculate a threshold by using the baseline minimum value that is above 0}}
\DoxyCodeLine{46   \textcolor{comment}{// with a static offset, this ensures whatever the baseline light level and/or}}
\DoxyCodeLine{47   \textcolor{comment}{// hardware sensitivity is it will always pick a threshold just above the 'off'}}
\DoxyCodeLine{48   \textcolor{keywordflow}{if} (val > \mbox{\hyperlink{VLReceiver_8cpp_aa3c9d5bc3f1c3dfec69046200aecb29a}{MIN\_THRESHOLD}} \&\& val < (\mbox{\hyperlink{VLReceiver_8cpp_ab1306e35299d8bdd10ea0adfbf9827ad}{threshold}} + \mbox{\hyperlink{VLReceiver_8cpp_ac97aa4e68f9c89b8c71d011b0956de1f}{BASE\_OFFSET}})) \{}
\DoxyCodeLine{49     \mbox{\hyperlink{VLReceiver_8cpp_ab1306e35299d8bdd10ea0adfbf9827ad}{threshold}} = val + \mbox{\hyperlink{VLReceiver_8cpp_ac97aa4e68f9c89b8c71d011b0956de1f}{BASE\_OFFSET}};}
\DoxyCodeLine{50   \}}
\DoxyCodeLine{51   \textcolor{comment}{// compare the current analog value to the light threshold}}
\DoxyCodeLine{52   \textcolor{keywordtype}{bool} isAboveThreshold = (val > \mbox{\hyperlink{VLReceiver_8cpp_ab1306e35299d8bdd10ea0adfbf9827ad}{threshold}});}
\DoxyCodeLine{53   \textcolor{keywordflow}{if} (wasAboveThreshold != isAboveThreshold) \{}
\DoxyCodeLine{54     \mbox{\hyperlink{classVLReceiver_ada08a00c52a7d4aa531c332b358b386f}{VLReceiver::recvPCIHandler}}();}
\DoxyCodeLine{55     wasAboveThreshold = isAboveThreshold;}
\DoxyCodeLine{56   \}}
\DoxyCodeLine{57   \textcolor{comment}{// Clear the Window Comparator interrupt flag}}
\DoxyCodeLine{58   ADC0.INTFLAGS = ADC\_WCMP\_bm;}
\DoxyCodeLine{59 \}}
