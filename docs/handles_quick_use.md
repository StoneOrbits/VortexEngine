...
<img align="right" width="" height="220" class="device-icon" src="assets/images/handle-logo-square-512.png">

# Handles Quick Use Guide

Welcome to the Vortex Handles Quick-Use-Guide, this guide aims to get you up and running as fast as possible.
...
1. **Select Editor Connection Menu (Purple):**
2. **Pair with PC:**
