...
\DoxyCodeLine{51   \textcolor{keywordflow}{if} (!\mbox{\hyperlink{classVortex_a84b31157edd8814f3e7b545ca4c3fa00}{Vortex::vcallbacks}}()-\/>serialCheck()) \{}
\DoxyCodeLine{52     \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{53   \}}
\DoxyCodeLine{54   \mbox{\hyperlink{classVortex_a84b31157edd8814f3e7b545ca4c3fa00}{Vortex::vcallbacks}}()-\/>\mbox{\hyperlink{classVortexCallbacks_a88f75444b8e202760243d3aa6ba6939b}{serialBegin}}(\mbox{\hyperlink{VortexConfig_8h_ad89976cc0b5340110179f6ce40df3028}{SERIAL\_BAUD\_RATE}});}
...
\DoxyCodeLine{57   \textcolor{keywordflow}{if} (!Serial.available()) \{}
...
\DoxyCodeLine{62   Serial.begin(\mbox{\hyperlink{VortexConfig_8h_ad89976cc0b5340110179f6ce40df3028}{SERIAL\_BAUD\_RATE}});}
...
References Time\+::get\+Curtime(), is\+Connected(), m\+\_\+last\+Check, m\+\_\+serial\+Connected, M\+A\+X\+\_\+\+S\+E\+R\+I\+A\+L\+\_\+\+C\+H\+E\+C\+K\+\_\+\+I\+N\+T\+E\+R\+V\+AL, S\+E\+R\+I\+A\+L\+\_\+\+B\+A\+U\+D\+\_\+\+R\+A\+TE, Vortex\+Callbacks\+::serial\+Begin(), and Vortex\+::vcallbacks().
...
\DoxyCodeLine{142   \textcolor{keywordflow}{return} (\mbox{\hyperlink{classVortex_a84b31157edd8814f3e7b545ca4c3fa00}{Vortex::vcallbacks}}()-\/>serialAvail() > 0);}
...
\DoxyCodeLine{114   uint32\_t amt = \mbox{\hyperlink{classVortex_a84b31157edd8814f3e7b545ca4c3fa00}{Vortex::vcallbacks}}()-\/>\mbox{\hyperlink{classVortexCallbacks_a032caa2c7c4294b061a122206a1817cd}{serialAvail}}();}
...
\DoxyCodeLine{124     \textcolor{keywordflow}{if} (!\mbox{\hyperlink{classVortex_a84b31157edd8814f3e7b545ca4c3fa00}{Vortex::vcallbacks}}()-\/>serialRead((\textcolor{keywordtype}{char} *)\&\textcolor{keywordtype}{byte}, 1)) \{}
...
\DoxyCodeLine{130     byteStream.\mbox{\hyperlink{classByteStream_ad3b413f399f22d30548a61a5e01ef3a7}{serialize8}}(\textcolor{keywordtype}{byte});}
...
\DoxyCodeLine{98   \mbox{\hyperlink{classVortex_a84b31157edd8814f3e7b545ca4c3fa00}{Vortex::vcallbacks}}()-\/>\mbox{\hyperlink{classVortexCallbacks_ab3ecbd028fc042995432dfd1a79f365e}{serialWrite}}((\textcolor{keyword}{const} uint8\_t *)\&size, \textcolor{keyword}{sizeof}(size));}
\DoxyCodeLine{99   \mbox{\hyperlink{classVortex_a84b31157edd8814f3e7b545ca4c3fa00}{Vortex::vcallbacks}}()-\/>\mbox{\hyperlink{classVortexCallbacks_ab3ecbd028fc042995432dfd1a79f365e}{serialWrite}}((\textcolor{keyword}{const} uint8\_t *)byteStream.\mbox{\hyperlink{classByteStream_a6993f9575592309a501156db31f82554}{rawData}}(), byteStream.\mbox{\hyperlink{classByteStream_a755097adde5b21b33d3c4e3623d04f97}{rawSize}}());}
...
References is\+Connected(), Byte\+Stream\+::raw\+Data(), Byte\+Stream\+::raw\+Size(), Byte\+Stream\+::recalc\+C\+R\+C(), Vortex\+Callbacks\+::serial\+Write(), and Vortex\+::vcallbacks().
...
\DoxyCodeLine{81   \mbox{\hyperlink{classVortex_a84b31157edd8814f3e7b545ca4c3fa00}{Vortex::vcallbacks}}()-\/>\mbox{\hyperlink{classVortexCallbacks_ab3ecbd028fc042995432dfd1a79f365e}{serialWrite}}(buf, len);}
