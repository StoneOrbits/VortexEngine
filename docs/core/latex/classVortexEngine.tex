...
Definition at line 192 of file Vortex\+Engine.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{193 \{}
\DoxyCodeLine{194   \textcolor{keywordflow}{if} (major != \mbox{\hyperlink{VortexConfig_8h_ad51691e0bf3c0a33a9b4929507a7d4d8}{VORTEX\_VERSION\_MAJOR}}) \{}
\DoxyCodeLine{195     \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{196   \}}
\DoxyCodeLine{197   \textcolor{comment}{// minor version doesn't matter}}
...
Definition at line 91 of file Vortex\+Engine.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{92 \{}
\DoxyCodeLine{93   \textcolor{comment}{// cleanup in reverse order}}
\DoxyCodeLine{94   \textcolor{comment}{// NOTE: the embedded doesn't actually cleanup,}}
\DoxyCodeLine{95   \textcolor{comment}{//       but the test frameworks do}}
\DoxyCodeLine{96 \textcolor{preprocessor}{\#ifdef VORTEX\_LIB}}
\DoxyCodeLine{97   \mbox{\hyperlink{classModes_aa16cf03f84bc5d911d220580ba3aeb7a}{Modes::cleanup}}();}
\DoxyCodeLine{98   \mbox{\hyperlink{classMenus_afb9e47baa1d7322d865bc025202d7b9b}{Menus::cleanup}}();}
\DoxyCodeLine{99   \mbox{\hyperlink{classButtons_a4bee1374d1782a6006faee6f9d9bb792}{Buttons::cleanup}}();}
\DoxyCodeLine{100   \mbox{\hyperlink{classLeds_a2292420b1011485e315eff165bb201cf}{Leds::cleanup}}();}
\DoxyCodeLine{101   \mbox{\hyperlink{classVLSender_a49afba3c3cae06136ad8744e367fcdb3}{VLSender::cleanup}}();}
\DoxyCodeLine{102   \mbox{\hyperlink{classVLReceiver_a31fba601a6e82bc043c7d017d91ce015}{VLReceiver::cleanup}}();}
\DoxyCodeLine{103   \mbox{\hyperlink{classIRSender_a4d6de9609f8e501e494cb431082d800a}{IRSender::cleanup}}();}
\DoxyCodeLine{104   \mbox{\hyperlink{classIRReceiver_ad2ff2918f176f499520fcc457c56a089}{IRReceiver::cleanup}}();}
\DoxyCodeLine{105   \mbox{\hyperlink{classStorage_a2a1ce108c9a17f6175bfb9a9aba51703}{Storage::cleanup}}();}
\DoxyCodeLine{106   \mbox{\hyperlink{classTime_af813bd1f7e4c08f6d84f8831738fed32}{Time::cleanup}}();}
\DoxyCodeLine{107   \mbox{\hyperlink{classSerialComs_a4da654c236a9ca2ce7b47bc775303adf}{SerialComs::cleanup}}();}
...
References Buttons\+::cleanup(), Leds\+::cleanup(), Menus\+::cleanup(), Modes\+::cleanup(), Serial\+Coms\+::cleanup(), Storage\+::cleanup(), Time\+::cleanup(), IRReceiver\+::cleanup(), IRSender\+::cleanup(), VLReceiver\+::cleanup(), and VLSender\+::cleanup().
...
\begin{DoxyCode}{0}
\DoxyCodeLine{202 \{}
\DoxyCodeLine{203 \textcolor{preprocessor}{\#ifdef VORTEX\_LIB}}
\DoxyCodeLine{204   \textcolor{keywordflow}{return} \mbox{\hyperlink{classModes_a1e520dc2ee457bc93a795e9945249dbd}{Modes::curMode}}();}
\DoxyCodeLine{205 \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{206   \textcolor{comment}{// don't need this outside vortex lib}}
...
Definition at line 223 of file Vortex\+Engine.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{224 \{}
\DoxyCodeLine{225   \mbox{\hyperlink{Log_8h_a5d2f30bd1cbcf49f829a7e8eb6173c06}{DEBUG\_LOG}}(\textcolor{stringliteral}{"{}Sleeping"{}});}
\DoxyCodeLine{226   \textcolor{keywordflow}{if} (save) \{}
\DoxyCodeLine{227     \textcolor{comment}{// update the startup mode when going to sleep}}
\DoxyCodeLine{228     \mbox{\hyperlink{classModes_a86dc60444399ab04d49f77935f68e8dd}{Modes::setStartupMode}}(\mbox{\hyperlink{classModes_a7a1b8d5c48237ab106adbfc44ceb1055}{Modes::curModeIndex}}());}
\DoxyCodeLine{229     \textcolor{comment}{// save anything that hasn't been saved}}
\DoxyCodeLine{230     \mbox{\hyperlink{classModes_a1756081ee85dbcf672ddad5a3dcb4690}{Modes::saveStorage}}();}
\DoxyCodeLine{231   \}}
\DoxyCodeLine{232   \textcolor{comment}{// clear all the leds}}
\DoxyCodeLine{233   \mbox{\hyperlink{classLeds_a6f7c9cdfab407455403167fd8f2c350a}{Leds::clearAll}}();}
\DoxyCodeLine{234   \mbox{\hyperlink{classLeds_a7b552b40079b1179fd47f7aeea88878d}{Leds::update}}();}
\DoxyCodeLine{235   \textcolor{comment}{// enable the sleep bool}}
\DoxyCodeLine{236   \mbox{\hyperlink{classVortexEngine_a68bdf824c4c7b2303a1b1a37da67f496}{m\_sleeping}} = \textcolor{keyword}{true};}
\DoxyCodeLine{237 \}}
...
\DoxyCodeLine{50   \}}
\DoxyCodeLine{51   \textcolor{keywordflow}{if} (!\mbox{\hyperlink{classVLReceiver_a406cd003a5d26bfe07470261fdb022c1}{VLReceiver::init}}()) \{}
\DoxyCodeLine{52     \mbox{\hyperlink{Log_8h_a5d2f30bd1cbcf49f829a7e8eb6173c06}{DEBUG\_LOG}}(\textcolor{stringliteral}{"{}VLReceiver failed to initialize"{}});}
\DoxyCodeLine{53     \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{54   \}}
\DoxyCodeLine{55   \textcolor{keywordflow}{if} (!\mbox{\hyperlink{classVLSender_afe2303e108c0aad37695e257f1ba4dad}{VLSender::init}}()) \{}
\DoxyCodeLine{56     \mbox{\hyperlink{Log_8h_a5d2f30bd1cbcf49f829a7e8eb6173c06}{DEBUG\_LOG}}(\textcolor{stringliteral}{"{}VLSender failed to initialize"{}});}
\DoxyCodeLine{57     \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{58   \}}
\DoxyCodeLine{59   \textcolor{keywordflow}{if} (!\mbox{\hyperlink{classLeds_aa470a02f29041f373be156dc698ed4c7}{Leds::init}}()) \{}
\DoxyCodeLine{60     \mbox{\hyperlink{Log_8h_a5d2f30bd1cbcf49f829a7e8eb6173c06}{DEBUG\_LOG}}(\textcolor{stringliteral}{"{}Leds failed to initialize"{}});}
\DoxyCodeLine{61     \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{62   \}}
\DoxyCodeLine{63   \textcolor{keywordflow}{if} (!\mbox{\hyperlink{classButtons_ac5767a8af9ce64e39231833ad1b166ea}{Buttons::init}}()) \{}
\DoxyCodeLine{64     \mbox{\hyperlink{Log_8h_a5d2f30bd1cbcf49f829a7e8eb6173c06}{DEBUG\_LOG}}(\textcolor{stringliteral}{"{}Buttons failed to initialize"{}});}
\DoxyCodeLine{65     \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{66   \}}
\DoxyCodeLine{67   \textcolor{keywordflow}{if} (!\mbox{\hyperlink{classMenus_a370c7e15fdcd035a2816b9db1adab189}{Menus::init}}()) \{}
\DoxyCodeLine{68     \mbox{\hyperlink{Log_8h_a5d2f30bd1cbcf49f829a7e8eb6173c06}{DEBUG\_LOG}}(\textcolor{stringliteral}{"{}Menus failed to initialize"{}});}
\DoxyCodeLine{69     \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{70   \}}
\DoxyCodeLine{71   \textcolor{keywordflow}{if} (!\mbox{\hyperlink{classModes_a8b920de981d96ca9365b766a3f59fb73}{Modes::init}}()) \{}
\DoxyCodeLine{72     \mbox{\hyperlink{Log_8h_a5d2f30bd1cbcf49f829a7e8eb6173c06}{DEBUG\_LOG}}(\textcolor{stringliteral}{"{}Settings failed to initialize"{}});}
\DoxyCodeLine{73     \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{74   \}}
\DoxyCodeLine{75 }
\DoxyCodeLine{76 \textcolor{preprocessor}{\#if COMPRESSION\_TEST == 1}}
\DoxyCodeLine{77   compressionTest();}
\DoxyCodeLine{78 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{79 }
\DoxyCodeLine{80 \textcolor{preprocessor}{\#if SERIALIZATION\_TEST == 1}}
\DoxyCodeLine{81   serializationTest();}
\DoxyCodeLine{82 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{83 }
\DoxyCodeLine{84 \textcolor{preprocessor}{\#if TIMER\_TEST == 1}}
\DoxyCodeLine{85   timerTest();}
...
References DEBUG\+\_\+\+LOG, Buttons\+::init(), Leds\+::init(), Menus\+::init(), Modes\+::init(), Serial\+Coms\+::init(), Storage\+::init(), Time\+::init(), IRReceiver\+::init(), IRSender\+::init(), VLReceiver\+::init(), and VLSender\+::init().
...
Definition at line 152 of file Vortex\+Engine.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{153 \{}
\DoxyCodeLine{154   \textcolor{comment}{// the current tick}}
\DoxyCodeLine{155   uint32\_t now = \mbox{\hyperlink{classTime_a7c7a8e067bdbd5aaf119521539d30940}{Time::getCurtime}}();}
\DoxyCodeLine{156 }
\DoxyCodeLine{157   \textcolor{comment}{// if the menus are open and running then just return}}
\DoxyCodeLine{158   \textcolor{keywordflow}{if} (\mbox{\hyperlink{classMenus_ab7628e9188ad88b34acfb72f498b5a7c}{Menus::run}}()) \{}
\DoxyCodeLine{159     \textcolor{keywordflow}{return};}
\DoxyCodeLine{160   \}}
\DoxyCodeLine{161 }
\DoxyCodeLine{162   \textcolor{comment}{// check if we should enter the menu}}
\DoxyCodeLine{163   \textcolor{keywordflow}{if} (\mbox{\hyperlink{Button_8h_a0f2e1bfb2e10150496ad7fb75420713b}{g\_pButton}}-\/>\mbox{\hyperlink{classButton_a6ed2a4b4e00facf5c42a11ecd1f4e1c7}{isPressed}}() \&\& \mbox{\hyperlink{Button_8h_a0f2e1bfb2e10150496ad7fb75420713b}{g\_pButton}}-\/>\mbox{\hyperlink{classButton_a2e0dae337117cd85f69c8346d369504a}{holdDuration}}() > \mbox{\hyperlink{Timings_8h_a155fc794adbdc762cfbc71f55a04bc22}{MENU\_TRIGGER\_THRESHOLD\_TICKS}}) \{}
\DoxyCodeLine{164     \mbox{\hyperlink{Log_8h_a5d2f30bd1cbcf49f829a7e8eb6173c06}{DEBUG\_LOG}}(\textcolor{stringliteral}{"{}Entering Menu Selection..."{}});}
\DoxyCodeLine{165     \mbox{\hyperlink{classMenus_a1f8dacb375bd4d1ec18da2ed5a3e8cb3}{Menus::openMenuSelection}}();}
\DoxyCodeLine{166     \textcolor{keywordflow}{return};}
\DoxyCodeLine{167   \}}
\DoxyCodeLine{168 }
\DoxyCodeLine{169   \textcolor{comment}{// toggle auto cycle mode with many clicks at main modes}}
\DoxyCodeLine{170   \textcolor{keywordflow}{if} (\mbox{\hyperlink{Button_8h_a0f2e1bfb2e10150496ad7fb75420713b}{g\_pButton}}-\/>\mbox{\hyperlink{classButton_af08888134084d0640b6a891bdb755f14}{onConsecutivePresses}}(\mbox{\hyperlink{VortexConfig_8h_a99fb9bcab397455dbf9c0e2aa904d2d9}{AUTO\_CYCLE\_MODES\_CLICKS}})) \{}
\DoxyCodeLine{171     \mbox{\hyperlink{classVortexEngine_ae6812312d6c117bf487ea7d2754f8063}{m\_autoCycle}} = !\mbox{\hyperlink{classVortexEngine_ae6812312d6c117bf487ea7d2754f8063}{m\_autoCycle}};}
\DoxyCodeLine{172     \mbox{\hyperlink{classLeds_a5a3e2c090aa782f4ee7c71c01e8d8a69}{Leds::holdAll}}(\mbox{\hyperlink{classVortexEngine_ae6812312d6c117bf487ea7d2754f8063}{m\_autoCycle}} ? \mbox{\hyperlink{ColorConstants_8h_ab6c97468034c02fe204fd37036d9be15}{RGB\_GREEN}} : \mbox{\hyperlink{ColorConstants_8h_aa039288455af8a3812a35aa1e7b903e4}{RGB\_RED}});}
\DoxyCodeLine{173   \}}
\DoxyCodeLine{174 }
\DoxyCodeLine{175   \textcolor{comment}{// if auto cycle is enabled and the last switch was more than the delay ago}}
\DoxyCodeLine{176   \textcolor{keywordflow}{if} (\mbox{\hyperlink{classVortexEngine_ae6812312d6c117bf487ea7d2754f8063}{m\_autoCycle}} \&\& (\mbox{\hyperlink{classModes_ac20debd8d48811c3e669cc601996925d}{Modes::lastSwitchTime}}() + \mbox{\hyperlink{VortexConfig_8h_ae54a4f60fb47ad89ca3c3aafc3e77860}{AUTO\_RANDOM\_DELAY}} < now)) \{}
\DoxyCodeLine{177     \textcolor{comment}{// then switch to the next mode automatically}}
\DoxyCodeLine{178     \mbox{\hyperlink{classModes_a70c51e7490681e5ee6a6e6d8084b8fc4}{Modes::nextModeSkipEmpty}}();}
\DoxyCodeLine{179   \}}
\DoxyCodeLine{180 }
\DoxyCodeLine{181   \textcolor{comment}{// otherwise just play the modes}}
\DoxyCodeLine{182   \mbox{\hyperlink{classModes_a9e98b568fcd3d00b7c3f0705b5120925}{Modes::play}}();}
\DoxyCodeLine{183 \}}
...
Definition at line 185 of file Vortex\+Engine.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{186 \{}
\DoxyCodeLine{187   \textcolor{comment}{// serialize the vortex version}}
\DoxyCodeLine{188   \textcolor{keywordflow}{return} stream.\mbox{\hyperlink{classByteStream_a16016f5dc73e0d8b639f6bdbea252d4b}{serialize}}((uint8\_t)\mbox{\hyperlink{VortexConfig_8h_ad51691e0bf3c0a33a9b4929507a7d4d8}{VORTEX\_VERSION\_MAJOR}}) \&\&}
\DoxyCodeLine{189          stream.\mbox{\hyperlink{classByteStream_a16016f5dc73e0d8b639f6bdbea252d4b}{serialize}}((uint8\_t)\mbox{\hyperlink{VortexConfig_8h_a5192bd4a7eea3a54e5b00405185d9d4d}{VORTEX\_VERSION\_MINOR}});}
\DoxyCodeLine{190 \}}
...
Definition at line 111 of file Vortex\+Engine.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{112 \{}
\DoxyCodeLine{113 \textcolor{preprocessor}{\#ifdef VORTEX\_LIB}}
\DoxyCodeLine{114   \textcolor{keywordflow}{if} (\mbox{\hyperlink{classVortexEngine_a68bdf824c4c7b2303a1b1a37da67f496}{m\_sleeping}}) \{}
\DoxyCodeLine{115     \textcolor{comment}{// update the buttons to check for wake}}
\DoxyCodeLine{116     \mbox{\hyperlink{classButtons_a4e775beebe1f2c6dce04c82ed14741cb}{Buttons::update}}();}
\DoxyCodeLine{117     \textcolor{comment}{// several fast clicks will unlock the device}}
\DoxyCodeLine{118     \textcolor{keywordflow}{if} (\mbox{\hyperlink{classModes_abe515fae0059b1213ba544b613051e97}{Modes::locked}}() \&\& \mbox{\hyperlink{Button_8h_a0f2e1bfb2e10150496ad7fb75420713b}{g\_pButton}}-\/>\mbox{\hyperlink{classButton_af08888134084d0640b6a891bdb755f14}{onConsecutivePresses}}(\mbox{\hyperlink{VortexConfig_8h_a2f5ef442fae5fcc560776b23fa1ccef3}{DEVICE\_LOCK\_CLICKS}} -\/ 1)) \{}
\DoxyCodeLine{119       \textcolor{comment}{// turn off the lock flag and save it to disk}}
\DoxyCodeLine{120       \mbox{\hyperlink{classModes_a1ae90978222b457a941f0cbf7dd9b46b}{Modes::setLocked}}(\textcolor{keyword}{false});}
\DoxyCodeLine{121     \}}
\DoxyCodeLine{122     \textcolor{comment}{// check for any kind of press to wakeup}}
\DoxyCodeLine{123     \textcolor{keywordflow}{if} (\mbox{\hyperlink{Button_8h_a0f2e1bfb2e10150496ad7fb75420713b}{g\_pButton}}-\/>\mbox{\hyperlink{classButton_a0a4fbfb56d10cb2c6e69a35eb62b7292}{check}}() || \mbox{\hyperlink{Button_8h_a0f2e1bfb2e10150496ad7fb75420713b}{g\_pButton}}-\/>\mbox{\hyperlink{classButton_a277f0bc922ec0cb3a20b6aaf43e9b94e}{onRelease}}() || !Vortex::sleepEnabled()) \{}
\DoxyCodeLine{124       \mbox{\hyperlink{classVortexEngine_a32e7878bb1f4e4c4d141e849ff7808fb}{wakeup}}();}
\DoxyCodeLine{125     \}}
\DoxyCodeLine{126     \textcolor{keywordflow}{return};}
\DoxyCodeLine{127   \}}
\DoxyCodeLine{128 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{129   \textcolor{comment}{// handle any fatal errors that may have occurred}}
\DoxyCodeLine{130   \textcolor{comment}{// but only if the error blinker is enabled}}
\DoxyCodeLine{131 \textcolor{preprocessor}{\#if VORTEX\_ERROR\_BLINK == 1}}
\DoxyCodeLine{132   \textcolor{keywordflow}{if} (getError() != \mbox{\hyperlink{ErrorBlinker_8h_abe670cc5ceed3fad3be682fc0c1bb62e}{ERROR\_NONE}}) \{}
\DoxyCodeLine{133     \textcolor{comment}{// just blink the error and don't run anything}}
\DoxyCodeLine{134     blinkError();}
\DoxyCodeLine{135     \textcolor{keywordflow}{return};}
\DoxyCodeLine{136   \}}
\DoxyCodeLine{137 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{138 }
\DoxyCodeLine{139   \textcolor{comment}{// tick the current time counter forward}}
\DoxyCodeLine{140   \mbox{\hyperlink{classTime_a823b10e685d34b667e16e36fea96e150}{Time::tickClock}}();}
\DoxyCodeLine{141 }
\DoxyCodeLine{142   \textcolor{comment}{// poll the button(s) and update the button object states}}
\DoxyCodeLine{143   \mbox{\hyperlink{classButtons_a4e775beebe1f2c6dce04c82ed14741cb}{Buttons::update}}();}
\DoxyCodeLine{144 }
\DoxyCodeLine{145   \textcolor{comment}{// run the main logic for the engine}}
\DoxyCodeLine{146   \mbox{\hyperlink{classVortexEngine_ad8500f86579f3e6d9f887698e181b4d2}{runMainLogic}}();}
\DoxyCodeLine{147 }
\DoxyCodeLine{148   \textcolor{comment}{// update the leds}}
...
Definition at line 239 of file Vortex\+Engine.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{240 \{}
\DoxyCodeLine{241   \mbox{\hyperlink{Log_8h_a5d2f30bd1cbcf49f829a7e8eb6173c06}{DEBUG\_LOG}}(\textcolor{stringliteral}{"{}Waking up"{}});}
\DoxyCodeLine{242   \mbox{\hyperlink{classVortexEngine_a68bdf824c4c7b2303a1b1a37da67f496}{m\_sleeping}} = \textcolor{keyword}{false};}
\DoxyCodeLine{243   \textcolor{comment}{// need to fake the reset in vortexlib, lol this works I guess}}
\DoxyCodeLine{244   \textcolor{keywordflow}{if} (reset) \{}
\DoxyCodeLine{245     \mbox{\hyperlink{classVortexEngine_ae80679477cd0c0f726e610b26fc1a6db}{cleanup}}();}
\DoxyCodeLine{246     \mbox{\hyperlink{classVortexEngine_a7d0883a55ea519ac58a24637c0cc38d2}{init}}();}
\DoxyCodeLine{247   \}}
\DoxyCodeLine{248 \}}
