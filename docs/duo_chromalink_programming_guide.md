...
It is important the Duo is up to date before programming from the PC. Make sure to [update the Duo](duo_chromalink_upgrade_guide.html) before continuing with this guide.
