...
\definecolor{sectionline}{RGB}{100,100,100}
...
\newcommand{\msection}[3]{\vspace{4pt}\noindent\textbf{\color{#1}\large \href{#2}{#3}}\vspace{2pt}}
\newcommand{\tsection}[1]{\vspace{4pt}\noindent\textbf{\color{twhite}\large #1}\vspace{2pt}}
\newcommand{\desc}[1]{\textcolor{tgray}{#1}}
\newcommand{\sectiondivider}{\vspace{2mm}\noindent\textcolor{sectionline}{\rule{\linewidth}{0.5pt}}\vspace{0mm}}
\newcommand{\sectiontitle}[1]{\vspace{1mm}\noindent\textbf{\color{purple}\large #1}\vspace{0.5mm}}
...
% ========== SECTION 4: WEB TOOLS ==========
\sectiontitle{WEB TOOLS \& RESOURCES}

\tsection{Useful Links}
\desc{Be sure to visit these}
\begin{itemize}
    ...
    \item Find our discord on the \href{https://stoneorbits.github.io/VortexEngine/support/index.html}{\texttt{Wiki!}}
\end{itemize}
...
\tsection{Interface}
\desc{How to interact with the Duo}
\begin{itemize}
    \item All \textbf{SHORT} or \textbf{LONG} (250ms) clicks
...
\desc{Main Features}
\begin{itemize}
  \item \textbf{Turn ON}: \textbf{SHORT} click from OFF
  \item \textbf{Turn OFF}: \textbf{LONG} click from ON
  \item \textbf{Access Menus}: \textbf{HOLD} till white
  \item \textbf{Conjure Mode}: \textbf{LONG} click from OFF
  \item \textbf{Light Lock}: 5x \textbf{SHORT} from OFF
  \item \textbf{Force Sleep / Panic Exit}: \textbf{HOLD} 10s
\end{itemize}

\sectiondivider

% ========== SECTION 2: SELECTING FEATURES ==========
\sectiontitle{SELECTING MENUS \& LEDS}

\msection{white}{https://stoneorbits.github.io/VortexEngine/vortex-engine/menus/index.html}{Menus}
...
\begin{itemize}
    ...
    \end{itemize}
    \item Quick exit: enter randomizer then exit
\end{itemize}
\vspace{3pt}

\msection{purple}{https://stoneorbits.github.io/VortexEngine/vortex-engine/menus/led-selection.html}{LED Selection}
...
\begin{itemize}
  ...
  \item Choose the affected LED(s)
...
\sectiontitle{MENU OPERATION}

\msection{whiteled}{https://stoneorbits.github.io/VortexEngine/vortex-engine/menus/randomizer.html}{Randomizer}
\begin{tikzpicture}[scale=0.6, baseline=0ex]
...
\msection{cyan}{https://stoneorbits.github.io/VortexEngine/vortex-engine/menus/mode-sharing/index.html}{Mode Sharing}
...
\msection{green}{https://stoneorbits.github.io/VortexEngine/vortex-engine/menus/color-select.html}{Color Select}
...
\msection{blue}{https://stoneorbits.github.io/VortexEngine/vortex-engine/menus/pattern-select.html}{Pattern Select}
...
\msection{yellow}{https://stoneorbits.github.io/VortexEngine/vortex-engine/menus/global-brightness.html}{Brightness}
...
\msection{red}{https://stoneorbits.github.io/VortexEngine/vortex-engine/menus/factory-reset.html}{Factory Reset}
