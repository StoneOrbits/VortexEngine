...
\begin{DoxyCode}{0}
\DoxyCodeLine{196 \{}
\DoxyCodeLine{197 \textcolor{preprocessor}{\#ifdef \_WIN32}}
...
Referenced by Timer\+::alarm(), Leds\+::blink\+All(), Leds\+::blink\+Index(), Leds\+::blink\+Map(), Leds\+::blink\+Pair(), Leds\+::blink\+Pairs(), Leds\+::blink\+Range(), Serial\+Coms\+::check\+Serial(), Timer\+::on\+End(), Timer\+::on\+Start(), Menus\+::open\+Menu\+Selection(), Mode\+Sharing\+::receive\+Mode\+VL(), Randomizer\+::run(), Vortex\+Engine\+::run\+Main\+Logic(), Menus\+::run\+Menu\+Selection(), VLSender\+::send(), Modes\+::set\+Cur\+Mode(), Main\+Menu\+::show(), Menu\+::show\+Bulb\+Selection(), Color\+Select\+::show\+Full\+Set(), Color\+Select\+::show\+Selection(), Timer\+::start(), and Button\+::update().
...
Referenced by VLSender\+::begin\+Send(), delay\+Microseconds(), init(), VLReceiver\+::recv\+PCIHandler(), and tick\+Clock().
