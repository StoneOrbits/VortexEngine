...
\DoxyCodeLine{57   \}}
\DoxyCodeLine{58   Vortex::vcallbacks()-\/>serialBegin(9600);}
...
\DoxyCodeLine{61   \textcolor{keywordflow}{if} (!Serial) \{}
...
\DoxyCodeLine{66   Serial.begin(9600);}
...
\DoxyCodeLine{134     byteStream.\mbox{\hyperlink{classByteStream_a16016f5dc73e0d8b639f6bdbea252d4b}{serialize}}(\textcolor{keywordtype}{byte});}
