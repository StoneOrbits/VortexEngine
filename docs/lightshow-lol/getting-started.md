...
<div class="image-container">
    <img src="{{ '/assets/images/vortex-device.png' | relative_url }}" alt="Vortex Device">
    <img style="max-width:30%" src="{{ '/assets/images/USB-Cable.png' | relative_url }}" alt="USB Cable">
    <img src="{{ '/assets/images/computer-icon.png' | relative_url }}" alt="Computer">
</div>
...
<div style="text-align: center; margin: 0 auto; max-width: 35%;">
  <img src="{{ '/assets/images/lightshow-lol-ports.png' | relative_url }}" style="box-shadow: 2px 2px 10px rgba(0, 0, 0, 0.2); border-radius: 5px;">
</div>
...
<div style="text-align: center; max-width: 700px; margin: 20px auto;">
  <div style="display: flex; flex-direction: column; align-items: center; gap: 15px;">
    <img height="300" src="{{ '/assets/images/spark-firmware-update.png' | relative_url }}" alt="Firmware Update Panel">
  </div>
</div>
