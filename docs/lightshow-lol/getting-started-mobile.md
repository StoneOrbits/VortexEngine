...
<div style="max-width: 30%; text-align: right; margin-left: 0.5em; float: right">
  <img src="{{ '/assets/images/lightshow-lol-mobile-new.gif' | relative_url }}" style="box-shadow: 2px 2px 10px rgba(0, 0, 0, 0.2); border-radius: 5px;">
</div>
...
3. **Now switch the device on** and it should appear in the list
