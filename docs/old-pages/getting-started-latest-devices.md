...
## Spark Orbit - Spark Handles - Chromadeck
  ...
  <img width="220" height="220" class="device-icon" src="{{ '/assets/images/spark-orbit-render-square-512.png' | relative_url }}" alt="Spark Orbit">
  <img width="220" height="220" class="device-icon" src="{{ '/assets/images/spark-handle-render-square-512.png' | relative_url }}" alt="Spark Handle">
  <img width="220" height="220" class="device-icon" src="{{ '/assets/images/chromadeck-render-square-512.png' | relative_url }}" alt="Chromadeck">
