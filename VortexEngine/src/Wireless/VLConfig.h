...
#define VL_TIMING (uint16_t)(3230)
#define VL_TIMING_MIN ((uint16_t)(VL_TIMING * VL_THRES_DOWN))
...
#define DVL_TIMING m_vlTiming
#define DVL_TIMING_MIN ((uint16_t)(DVL_TIMING * VL_THRES_DOWN))

#define DVL_HEADER_MARK (uint16_t)(DVL_TIMING * 16)
#define DVL_HEADER_SPACE (uint16_t)(DVL_TIMING * 8)

#define DVL_HEADER_MARK_MIN ((uint16_t)(VL_HEADER_MARK * VL_THRES_DOWN))
#define DVL_HEADER_SPACE_MIN ((uint16_t)(DVL_HEADER_SPACE * VL_THRES_DOWN))

#define DVL_HEADER_MARK_MAX ((uint16_t)(DVL_HEADER_MARK * VL_THRES_UP))
#define DVL_HEADER_SPACE_MAX ((uint16_t)(DVL_HEADER_SPACE * VL_THRES_UP))
