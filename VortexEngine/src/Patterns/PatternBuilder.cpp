...
PatternArgs PatternBuilder::getDefaultArgs(PatternID id)
{
  switch (id) {
    ...
    case PATTERN_DOPYGAP: return PatternArgs(DOPY_ON_DURATION, DOPY_OFF_DURATION, 60);
    case PATTERN_ULTRAGAP: return PatternArgs(ULTRADOPS_ON_DURATION, ULTRADOPS_OFF_DURATION, 55);
    case PATTERN_BLINKIE: return PatternArgs(3, 8, 110);
    case PATTERN_GHOSTCRUSH: return PatternArgs(3, 3, 18);
    case PATTERN_DOUBLEDOPS: return PatternArgs(ULTRADOPS_ON_DURATION, ULTRADOPS_OFF_DURATION, 40, 0, 2);
    case PATTERN_CHOPPER: return PatternArgs(ULTRADOPS_ON_DURATION, STROBIE_OFF_DURATION, 0, STROBE_ON_DURATION);
    case PATTERN_DASHGAP: return PatternArgs(ULTRADOPS_ON_DURATION, ULTRADOPS_OFF_DURATION, 70, 40);
    case PATTERN_DASHDOPS: return PatternArgs(DOPY_ON_DURATION, DOPY_OFF_DURATION, DOPY_OFF_DURATION, 50);
    case PATTERN_DASHCRUSH: return PatternArgs(4, 1, 20, 50);
    case PATTERN_ULTRADASH: return PatternArgs(ULTRADOPS_ON_DURATION, ULTRADOPS_OFF_DURATION, ULTRADOPS_OFF_DURATION, 14);
    case PATTERN_GAPCYCLE: return PatternArgs(ULTRADOPS_ON_DURATION, STROBIE_OFF_DURATION, 40, 40, 2);
    ...
    case PATTERN_HUE_SHIFT: return PatternArgs(BLEND_ON_DURATION, BLEND_OFF_DURATION, 0, 0, 0, 10, 1);
    case PATTERN_HUE_SHIFT_STROBE: return PatternArgs(STROBE_ON_DURATION, STROBE_OFF_DURATION, 0, 0, 0, 10, 1);
    case PATTERN_HUE_SHIFT_STROBEGAP: return PatternArgs(STROBE_ON_DURATION, STROBE_OFF_DURATION, 75, 0, 0, 10, 1);
    case PATTERN_COMPLEMENTARY_HUE_SHIFT: return PatternArgs(BLEND_ON_DURATION, BLEND_OFF_DURATION, 0, 0, 0, 10, 2);
    case PATTERN_COMPLEMENTARY_HUE_SHIFT_STROBE: return PatternArgs(STROBE_ON_DURATION, STROBE_OFF_DURATION, 0, 0, 0, 10, 2);
    case PATTERN_COMPLEMENTARY_HUE_SHIFT_STROBEGAP: return PatternArgs(STROBE_ON_DURATION, STROBE_OFF_DURATION, 75, 0, 0, 10, 2);
    ...
    case PATTERN_VORTEXWIPE: return PatternArgs(DOPY_ON_DURATION, DOPY_OFF_DURATION, 130);
    case PATTERN_WARP: return PatternArgs(DOPS_ON_DURATION, DOPS_OFF_DURATION, 150);
    case PATTERN_WARPWORM: return PatternArgs(DOPY_ON_DURATION, DOPY_OFF_DURATION, 110);
    case PATTERN_SNOWBALL: return PatternArgs(DOPY_ON_DURATION, DOPY_OFF_DURATION, 110);
    case PATTERN_LIGHTHOUSE: return PatternArgs(DOPY_ON_DURATION, DOPY_OFF_DURATION, 100, 25, 5);
    case PATTERN_PULSISH: return PatternArgs(DOPY_ON_DURATION, DOPY_OFF_DURATION, STROBE_ON_DURATION, STROBE_OFF_DURATION, 250);
...
Pattern *PatternBuilder::generate(PatternID id, const PatternArgs *userArgs)
{
  ...
  switch (id) {
    ...
    case PATTERN_HUE_SHIFT_STROBE:
    case PATTERN_HUE_SHIFT_STROBEGAP:
    case PATTERN_COMPLEMENTARY_HUE_SHIFT:
    case PATTERN_COMPLEMENTARY_HUE_SHIFT_STROBE:
    case PATTERN_COMPLEMENTARY_HUE_SHIFT_STROBEGAP: return new BlendPattern(args);
