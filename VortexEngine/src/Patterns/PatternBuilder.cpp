...
PatternArgs PatternBuilder::getDefaultArgs(PatternID id)
{
  switch (id) {
    ...
    case PATTERN_DOPY: return PatternArgs(DOPISH_ON_DURATION, DOPISH_OFF_DURATION);
    ...
    case PATTERN_DOPYGAP: return PatternArgs(DOPISH_ON_DURATION, DOPISH_OFF_DURATION, 30);
    ...
    case PATTERN_DASHDOPS: return PatternArgs(DOPISH_ON_DURATION, DOPISH_OFF_DURATION, DOPISH_OFF_DURATION, 30);
