...
PatternArgs PatternBuilder::getDefaultArgs(PatternID id)
{
  switch (id) {
    ...
    case PATTERN_DOPSGAP: return PatternArgs(DOPS_ON_DURATION, DOPS_OFF_DURATION, 60);
    ...
    case PATTERN_DASHDOPS: return PatternArgs(DOPS_ON_DURATION, DOPS_OFF_DURATION, DOPS_OFF_DURATION, 50);
