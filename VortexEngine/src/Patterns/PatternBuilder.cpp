...
PatternArgs PatternBuilder::getDefaultArgs(PatternID id)
{
  switch (id) {
    ...
    case PATTERN_STROBEGAP: return PatternArgs(STROBE_ON_DURATION, STROBE_OFF_DURATION, 75);
    case PATTERN_HYPERGAP: return PatternArgs(HYPERSTROBE_ON_DURATION, HYPERSTROBE_OFF_DURATION, 120);
    case PATTERN_DOPGAP: return PatternArgs(DOPS_ON_DURATION, DOPS_OFF_DURATION, 60);
    case PATTERN_STROBIEGAP: return PatternArgs(STROBIE_ON_DURATION, STROBIE_OFF_DURATION, 90);
    case PATTERN_DOPYGAP: return PatternArgs(DOPY_ON_DURATION, DOPY_OFF_DURATION, 30);
    case PATTERN_ULTRAGAP: return PatternArgs(ULTRADOPS_ON_DURATION, ULTRADOPS_OFF_DURATION, 25);
    case PATTERN_BLINKIE: return PatternArgs(2, 4, 60);
    case PATTERN_GHOSTCRUSH: return PatternArgs(2, 1, 10);
    case PATTERN_DOUBLEDOPS: return PatternArgs(ULTRADOPS_ON_DURATION, ULTRADOPS_OFF_DURATION, HYPERSTROBE_OFF_DURATION, 0, 2);
    case PATTERN_CHOPPER: return PatternArgs(ULTRADOPS_ON_DURATION, STROBIE_OFF_DURATION, 0, STROBE_ON_DURATION);
    case PATTERN_DASHGAP: return PatternArgs(ULTRADOPS_ON_DURATION, ULTRADOPS_OFF_DURATION, 35, 20);
    case PATTERN_DASHDOPS: return PatternArgs(DOPY_ON_DURATION, DOPY_OFF_DURATION, DOPY_OFF_DURATION, 30);
    case PATTERN_DASHCRUSH: return PatternArgs(4, 1, 10, 30);
    case PATTERN_ULTRADASH: return PatternArgs(ULTRADOPS_ON_DURATION, ULTRADOPS_OFF_DURATION, ULTRADOPS_OFF_DURATION, 8);
    case PATTERN_GAPCYCLE: return PatternArgs(ULTRADOPS_ON_DURATION, STROBIE_OFF_DURATION, 25, 25, 2);
    case PATTERN_DASHCYCLE: return PatternArgs(ULTRADOPS_ON_DURATION, ULTRADOPS_OFF_DURATION, ULTRADOPS_OFF_DURATION, 8, 2);
