...
PatternArgs PatternBuilder::getDefaultArgs(PatternID id)
{
  switch (id) {
    ...
    case PATTERN_BLENDSTROBEGAP: return PatternArgs(STROBE_ON_DURATION, STROBE_OFF_DURATION, 25, 0, 0, 9, 1);
    ...
    case PATTERN_COMPLEMENTARY_BLENDSTROBEGAP: return PatternArgs(STROBE_ON_DURATION, STROBE_OFF_DURATION, 25, 0, 0, 9, 2);
