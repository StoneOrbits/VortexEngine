...
enum PatternID : int8_t
{
  ...
  PATTERN_HUE_SHIFT,
  PATTERN_HUE_SHIFT_STROBE,
  PATTERN_HUE_SHIFT_STROBEGAP,
  PATTERN_COMPLEMENTARY_HUE_SHIFT,
  PATTERN_COMPLEMENTARY_HUE_SHIFT_STROBE,
  PATTERN_COMPLEMENTARY_HUE_SHIFT_STROBEGAP,
  PATTERN_SOLID,
