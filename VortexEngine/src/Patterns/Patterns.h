...
enum PatternID : int8_t
{
  ...
  PATTERN_BLEND_STROBEGAP,
  PATTERN_COMP_BLEND,
  PATTERN_COMP_BLEND_STROBE,
  PATTERN_COMP_BLEND_STROBEGAP,
  PATTERN_HUE_SHIFT,
  PATTERN_HSHIFT_STROBE,
  PATTERN_HSHIFT_STROBEGAP,
  PATTERN_COMP_HSHIFT,
  PATTERN_COMP_HSHIFT_STROBE,
  PATTERN_COMP_HSHIFT_STROBEGAP,
  PATTERN_SOLID,
  ...
  PATTERN_HUESCROLL = PATTERN_MULTI_FIRST,
