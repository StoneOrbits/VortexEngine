...
EMSCRIPTEN_BINDINGS(Vortex) {
  ...
  enum_<LedPos>("LedPos")
    ...
    .value("LED_10", LedPos::LED_10)
    .value("LED_11", LedPos::LED_11)
    .value("LED_12", LedPos::LED_12)
    .value("LED_13", LedPos::LED_13)
    .value("LED_14", LedPos::LED_14)
    .value("LED_15", LedPos::LED_15)
    .value("LED_16", LedPos::LED_16)
    .value("LED_17", LedPos::LED_17)
    .value("LED_18", LedPos::LED_18)
    .value("LED_19", LedPos::LED_19)
    .value("LED_20", LedPos::LED_20)
    .value("LED_21", LedPos::LED_21)
    .value("LED_22", LedPos::LED_22)
    .value("LED_23", LedPos::LED_23)
    .value("LED_24", LedPos::LED_24)
    .value("LED_25", LedPos::LED_25)
    .value("LED_26", LedPos::LED_26)
    .value("LED_27", LedPos::LED_27)
